	...
	public static void main(String[] args) {
		...
		WebElement ABC = wait.until(new Function<WebDriver, WebElement>() {
			...
			public WebElement apply(WebDriver driver) {
				if(driver.findElement(By.xpath("//div/h4[.='Hello World!']")).isDisplayed())
				{
					return driver.findElement(By.xpath("//div/h4[.='Hello World!']"));
				}
				else
					return null;
			}
		});
		System.out.println(driver.findElement(By.xpath("//div/h4[.='Hello World!']")).getText());
